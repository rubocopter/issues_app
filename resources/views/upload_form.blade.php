    ...
    <div class="content div-form">
        <form action="/upload" id="issueForm" data-toggle="validator" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group has-feedback">
                ...
                <input type="text" class="form-control" id="inputName" name="name" aria-describedby="inputName" placeholder="Enter your name."
            ...
            <div class="form-group has-feedback">
                ...
                <input type="text" class="form-control" id="inputName" name="institution" aria-describedby="inputInstitution" placeholder="Enter your institution."
                    data-error="Please enter the name of your institution." required>
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                <div class="help-block with-errors"></div>
            </div>
            ...
            <div class="form-group has-feedback">
                ...
                <input type="email" class="form-control" id="inputEmail" placeholder="Enter your Email address." name="email" data-error="That email address is invalid."
                    required>
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                <div class="help-block with-errors"></div>
            </div>
            ...
            <div class="form-group has-feedback">
                <label>Is this issue from this browser and operating system?</label>

                <input style="width: 25px;height: 20px;" type="checkbox" onclick="onToggle()" id="cbox1" value="first_checkbox">
            </div>
            ...
            <div class="form-group has-feedback" id="divBrowser">
                ...
                <input type="text" class="form-control" id="inputBrowser" aria-describedby="inputBrowser" placeholder="Name and version of your browser."
                    name="browser" data-error="Please fill the information about your web browser." required>
                <p>
                    <a href="/browserHelp" target="_blank">How to find version of installed Internet browser.</a>
                </p>
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                <div class="help-block with-errors"></div>
            </div>
            ...
            <div class="form-group has-feedback">
                ...
                <textarea class="form-control" placeholder="Explain the problems experienced in the application" id="issueTextarea" rows="4"
                    data-error="Please tell us about your issue." name="issue_info" required></textarea>
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                <div class="help-block with-errors"></div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="file" name="screenshots[]" class="form-control-file" id="fileAttachment" aria-describedby="fileHelp" accept="image/*"
